...
public class LineUpWithWallHelperMicroTest  extends TestCase{
	...
	public void testForDrive_GreaterThan8() {
		...
		assertEquals(-0.6, ((MockLineUpWithWallHelper)lineUpWithWallHelper).outputMagnitude);
	...
	@Test
	// robot in range (closer than 8 inches), but right is greater than left by more than one inch
	...
	@Test
	// robot in range (closer than 8 inches), but left is greater than right by more than one inch
